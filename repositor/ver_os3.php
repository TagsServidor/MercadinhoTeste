												...
												<div class="modal-dialog modal-dialog-centered">
													<div class="modal-content">
														...
														<div class="modal-body">
															...
															<form action="#" id="alerta_reposicao<?php echo $linhaos['os_produtos_id'] ?>" method="post">
															<label>DEVERIA </label>
																...
																<input type="hiddena" value="<?php echo $linhaos['os_produtos_id'] ?>" name="idosproduto">
...
<input type="number" name="cvencido" value=""  class="form-control">
</div>
</div>
<script>
$(document).ready(function(){
...
<div>
<label class="text-danger"><input type="checkbox" class="extravio" name="alerta_extravio" value="sim"> Extravio</label>
<div class="boxextravio" style="display:none">
<div class="col-12">
<label class="text-danger">QTD produtos encontrado no estoque</label>
<input type="number" name="cextravio" value=""  class="form-control">
</div>
</div>
<script>
$(document).ready(function(){
...
<input type="number" name="cencontradoamais" value=""  class="form-control">
</div>
</div>
<script>
$(document).ready(function(){
...
<input type="number" name="cenviadoparamais" value=""  class="form-control">
</div>
</div>
<script>
$(document).ready(function(){
...
<input type="number" name="cnaoveio" value=""  class="form-control">
</div>
</div>
<script>
$(document).ready(function(){
...
<input type="number" name="cperda" value=""  class="form-control">
</div>
</div>
<script>
$(document).ready(function(){
