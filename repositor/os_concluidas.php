												...
												<div id="todo_collapse_1" class="collapse show">
													<div class="card-body">
														<ul id="todo_list" class="advance-list">
															...
															<?php // LISTANDO OS CONCLUDAS
														
$sqlos = "SELECT * FROM os_reposicao o  inner join unidades u on o.os_unidade = u.id_unidade  inner join condominios c on u.unidade_condominio = c.id_condominio   where o.os_status  = '2' order by os_data desc  ";
...
while($linhaos = mysqli_fetch_array($resultadoos)){
	...
	?>
															<a href="ver_os_concluida/<?php echo $linhaos['id_os_reposicao'] ?>/<?php echo $linhaos['os_unidade'] ?>"> 
																...
																<div class="d-flex align-items-center justify-content-between">
																	<div class="d-flex align-items-center">
																		...
																		<div>	
																			...
																			<span style="color: #FCB00D"> <?php echo $linhaos['id_os_reposicao'] ?></span> <span class="todo-text text-dark text-truncate">  - <?php echo $linhaos['unidade_nome'] ?></span>
