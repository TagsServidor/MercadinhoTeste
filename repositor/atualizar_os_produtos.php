...
/// INSERINDO LOG PARA EVITAR DUPLICIDADE
@$conn->query($insert = "INSERT INTO log_reposicao (id_os_produto_repo, log_quem) VALUES ('$_POST[id]','$iduser')");


$sqllog= "SELECT * FROM log_reposicao  where id_os_produto_repo = '$_POST[id]'     ";
