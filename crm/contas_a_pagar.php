...
<div class="main-content">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Financeiro &gt; Contas a Pagar</h4> 

                                    <div class="page-title-right">
										 <div class="dropdown">
                                                    <button class="btn btn-info dropdown-toggle waves-effect waves-light" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        Adicionar Nova Conta <i class="fa fa-plus"></i>
                                                    </button>
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="add_conta_central">Centrais</a>
                                                        <a class="dropdown-item" href="add_conta_condominio">Condominios/Unidades</a>
                                                        <a class="dropdown-item" href="add_conta_fornecedor">Fornecedores</a>
                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Temos um total de (<?php echo $total ?>) contas cadastradas </h4><br>
...
while($linha = mysqli_fetch_array($resultado)){
	...
	<!-- MODAL INFORMAR PAGAMENTO -->
                          ...
                          <td><div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="" data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $linha['id_apagar'] ?>"
                                                           >Informar Pagamento</a>
