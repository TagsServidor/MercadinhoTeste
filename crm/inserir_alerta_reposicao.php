...
$estoque = $_POST['encontrada'] + $_POST['reposta'] ; 
...
@$conn->query("update os_produtos set os_produtos_status =  '2'  where os_produtos_id = '$_POST[id]' ");
...
window.location.href = "ver_os_reposicao_r/<?php echo $_POST['os'] ?>";
