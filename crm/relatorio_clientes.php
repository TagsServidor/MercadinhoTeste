...
$sql = "SELECT * FROM clientes c INNER JOIN unidades u on c.cliente_unidade = u.id_unidade ";
...
<div class="main-content">
                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Temos um total de (<?php echo $total ?>) clientes cadastrados </h4><br>
	...
	?>
                          ...
                          <td><?php echo $linha['cliente_cpf'] ?></td>
							...
							<td><?php echo $linha['unidade_nome'] ?></td>
								...
								<td><?php if ($linha['cliente_status'] =='1' ) { ?><span class="btn btn-success btn-sm">Ativo </span><?php } ?> <?php if ($linha['cliente_status'] =='2' ) { ?><span class="btn btn-danger btn-sm">Inativo </span><?php } ?><?php if ($linha['cliente_status'] =='3' ) { ?><span class="btn btn-danger btn-sm">Bloqueado </span><?php } ?></td>
							
                          <td> 
															<a href = "perfil_cliente/<?php echo $linha[id_cliente] ?>">  
	 ...
	 $("#formos<?php echo $linha['id_cliente'] ?>").submit(function(){
