...
// VENCIDO
if (($_POST[alerta] == '3') or ($_POST[alerta] == '2')) { 

if ($_POST[unidade] <> '') { 
$result_vendas = "SELECT  SUM( alerta_estoque_deveria - alerta_estoque_encontrado) AS qtd , ir_alerta_reposicao,  alerta_data, alerta_unidade, alerta_motivo, alerta_produto, alerta_data, alerta_produto_unidade  FROM alertas_reposicao where alerta_data BETWEEN '$_POST[inicio]' AND ' $_POST[fim]' and alerta_unidade = $_POST[unidade] and alerta_motivo = '$_POST[alerta]' group by alerta_produto ";
$sqluu = "SELECT * FROM unidades where id_unidade = $_POST[unidade]  ORDER BY unidade_nome";
$resultadouu = mysqli_query($conn, $sqluu);
$linhauu=mysqli_fetch_array($resultadouu);
	} else {
...
<!-- DataTables -->
        ...
        <link href="assets/libs/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css" rel="stylesheet" type="text/css" />   
                ...
                <div class="container-fluid">
                  <form action="relatorio_alerta_reposicao" method="post">
											   
											   <div class="row"> 
												   
												<div class="col-2">    <label><strong>Inicio:</strong></label>
...
// Selecionando os dados da tabela em ordem decrescente
$sql = "SELECT * FROM aletar_motivos where id_alerta <> 1 and id_alerta <> 6  and id_alerta <> 5   and id_alerta <> 4 and id_alerta <> 3  ";
// Executando $sql e verificando se tudo ocorreu certo.
$resultado = mysqli_query($conn, $sql);
//Realizando um loop para exibi&ccedil;&atilde;o de todos os dados 
while ($linha=mysqli_fetch_array($resultado)) {
...
?>
												   ...
												   <div class="col-1">  
															 <label>&nbsp;<br></label><br>
	<input type="hidden" class="form-control" value="sim" name="alertareposicao">
                  ...
                  <div class="card-body">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <th>Produto</th>
							 <th><?php if ($_POST[alerta] == '8') {  ?> Qtd a mais <?php } ?><?php if ($_POST[alerta] == '3') {  ?> Qtd vencido <?php } ?></th>
							 <th>Valor total</th>
