...
<!-- Bootstrap Css -->
   <link href="assets/css/bootstrap.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
        ...
        <link href="assets/css/app.min.css" id="app-style" rel="stylesheet" type="text/css" />
				...
				<div class="card">
				<div class="card-body">
                 <form action="vendas_periodo" method="post">
...
<select class="select2 form-control" id="idSelect2" required multiple="" tabindex="-1" name="local[]" style="display: none;">
      <option value="Pix">Terminal Pix</option>
	  <option value="Cartão de Debito">Terminal Débito</option>
	  <option value="Cartão de Credito">Terminal Crédito</option>
      <option value="PIXAPP">App Pix</option>
	  <option value="CreditCard">App Crédito</option>
