...
$sql_venda = "SELECT * FROM pedidos p INNER JOIN unidades u ON p.pedido_unidade = u.id_unidade where p.pedido_cliente = $id and p.pedido_status = 2  order by p.id_pedido  desc ";
...
$result_vendas = "SELECT * FROM pedidos p INNER JOIN unidades u ON p.pedido_unidade = u.id_unidade where p.pedido_cliente = $id  and p.pedido_status = 2 order by p.id_pedido  desc limit $incio, $quantidade_pg";
 ...
 <script src="//code.jquery.com/jquery-3.2.1.min.js"></script>
   ...
   <link href="assets/css/bootstrap.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
        ...
        <link href="assets/css/app.min.css" id="app-style" rel="stylesheet" type="text/css" />
                            ...
                            <div class="col-12">
                                ...
                                <h4 class="mb-0"> Relatórios &gt; Clientes >  Compras >  <?php echo $linha['cliente_nome'] ?></h4> 
                                    ...
                                    <div class="page-title-right">
										...
										<a href="perfil_cliente/<?php echo $id ?>"> <buttom class="btn btn-primary">Voltar </buttom> </a>
                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Temos um total de (<?php echo $total_vendas ?>) compras  registradas </h4><br>
