...
<div class="modal fade bs-example-modal-xl<?php echo $linhap['id_produto']; ?>" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-xl">
                                                        <div class="modal-content">
                                                            ...
                                                            $sql2 = "SELECT SUM(qtd_carrinho)  AS qtd_carrinho, status_carrinho, preco_pago, produto_carrinho, cliente_carrinho, cl.cliente_nome, id_cliente  FROM carrinho c  INNER JOIN clientes cl on c.cliente_carrinho = cl.id_cliente WHERE status_carrinho ='2' and preco_pago <> '0.00' and produto_carrinho = $linha[produto_carrinho] and cl.cliente_nome <> '' group by cliente_carrinho order by qtd_carrinho desc  ";
