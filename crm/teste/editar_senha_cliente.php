                ...
                <div class="card-body">
                    ...
                    <form id="formcentral" action="atualizar_registro_chamado/<?php echo($id) ?>" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label">Nome do cliente:<?php echo($id) ?</label>
                                    <input name="titulo" type="text" required class="form-control" id="titulo" placeholder="Informe o título do chamado" value="<?php echo($chamado['cliente_nome']) ?>">
