...
<script src="assets/js/jquery.js"></script>
 <script src="assets/js/form_condominio.js"></script>
...
<div class="main-content">
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        ...
                                        <a href="listar_condominios"><button class="btn btn-info"> Listar Condomínios </button></a>   
                                        </ol>
                                    </div>
                ...
                <div class="container-fluid">
					<div class="row">
                            <div class="col-12">
                                <div class="card">
					                 <div class="card-body">
                                        <h4 class="card-title">Adicionar Novo Condomínio</h4>
											  ...
											  <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="nome" type="text"  required class="form-control" id="nome" placeholder="Informe o nome do Condomínio">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="sindico" type="text" class="form-control" id="nome" placeholder="Informe o nome do Síndico">
												  ...
												  <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="apartamentos" type="number" class="form-control" id="nome" placeholder="">
			  ...
			  echo "<SELECT NAME='central' SIZE='1' class='form-control' required>

<OPTION VALUE='' SELECTED> Informe a central ";
