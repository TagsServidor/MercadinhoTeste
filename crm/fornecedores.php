...
<script src="assets/js/jquery.js"></script>
 <script src="assets/js/form_fornecedor.js"></script>
                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        ...
                                        <a href="listar_fornecedores"><button class="btn btn-info"> Listar Fornecedores </button></a>    
                                        </ol>
                                    </div>
                ...
                <div class="container-fluid">
					<div class="row">
                            <div class="col-12">
                                <div class="card">
					                 <div class="card-body">
                                        <h4 class="card-title">Adicionar Novo Fornecedor</h4>
											  ...
											  <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="nome" type="text"  required class="form-control" id="nome" placeholder="Informe o nome do Fornecedor Ex: Ambev">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="contato" type="text" class="form-control" id="contato" placeholder="Informe o nome do contato com o fornecedor">
