...
$sql = "SELECT * FROM clientes   where id_cliente = $_POST[cliente]  ";
...
<?php 
$sql_venda = "SELECT * FROM pedidos p INNER JOIN unidades u ON p.pedido_unidade = u.id_unidade where p.pedido_cliente = $_POST[cliente]  and p.pedido_status = 2  and pedido_data BETWEEN '$_POST[inicio]' AND ' $_POST[fim]'   order by p.id_pedido  desc ";
$resultado_venda = mysqli_query($conn, $sql_venda);

//Contar o total de cursos
$total_vendas = mysqli_num_rows($resultado_venda);

$result_vendas = "SELECT * FROM pedidos p INNER JOIN unidades u ON p.pedido_unidade = u.id_unidade where p.pedido_cliente = $_POST[cliente]  and p.pedido_status = 2 and pedido_data BETWEEN '$_POST[inicio]' AND ' $_POST[fim]'  order by p.id_pedido  desc ";
 ...
 <script src="//code.jquery.com/jquery-3.2.1.min.js"></script>
   ...
   <link href="assets/css/bootstrap.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
        ...
        <link href="assets/css/app.min.css" id="app-style" rel="stylesheet" type="text/css" />
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <h4 class="mb-0"> Relatórios &gt; Clientes >  Compras >  <?php echo $linha['cliente_nome'] ?></h4> 

                                    <div class="page-title-right">
									
                                        <ol class="breadcrumb m-0">
                                           <a href="perfil_cliente/<?php echo $_POST['cliente'] ?>"> <buttom class="btn btn-primary">Voltar </buttom> </a>
                ...
                <div class="container-fluid">
                 <form action="compras_clientes_data" method="post">
                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Temos um total de (<?php echo $total_vendas ?>) compras  registradas <span class="card-title">periodo de <?php echo date('d/m/Y', strtotime($_POST['inicio'])); ?> à <?php echo date('d/m/Y', strtotime($_POST['fim'])); ?> </h4><br>
				...
				<ul class="pagination">
					<li class="page-item">
						...
						if($pagina_anterior != 0){ ?>
							<a href="compras_clientes/<?php echo $id ?>/<?php echo $pagina_anterior; ?>"  class="page-link" aria-label="Previous">
					...
					for($i = 1; $i < $num_pagina + 1; $i++){ ?>
						<li class="nav-item"><a href="compras_clientes/<?php echo $id ?>/<?php echo $i; ?>" class="page-link"><?php echo $i; ?></a></li>
					<?php } ?>
					<li class="page-item">
						<?php
						if($pagina_posterior <= $num_pagina){ ?>
							<a href="compras_clientes/<?php echo $id ?>/<?php echo $pagina_posterior; ?>" class="page-link" aria-label="Previous">
