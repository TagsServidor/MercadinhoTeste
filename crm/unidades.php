                            ...
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        ...
                                        <a href="listar_unidades"><button class="btn btn-info"> Listar Unidades </button></a>    
                                        </ol>
                                    </div>
...
$sql = "SELECT * FROM condominios where condominio_status ='1' and condominio_lixeira = '1'  ORDER BY condominio_nome";
