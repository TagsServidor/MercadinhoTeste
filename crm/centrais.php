                                ...
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                         <a href="listar_centrais"><button class="btn btn-info"> Listar Centrais </button></a>
                                        </ol>
                                    </div>
                ...
                <div class="container-fluid">
					<div class="row">
                            <div class="col-12">
                                <div class="card">
					                 <div class="card-body">
                                        <h4 class="card-title">Adicionar Nova Central</h4>
											  ...
											  <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input name="nome" type="text"  required class="form-control" id="nome" placeholder="Informe o nome da central">
												   ...
												   <div class="col-md-6">
                                                    <div class="mb-3">
                                                      <label class="form-label" for="validationCustom01">Estado:</label>
                                                        <input name="uf" readonly=true type="text" class="form-control" id="uf" placeholder="Estado" maxlength="2">
