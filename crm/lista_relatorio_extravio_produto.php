        ...
        <link href="assets/libs/datatables.net-responsive-bs4/css/responsive.bootstrap4.min.css" rel="stylesheet" type="text/css" />   
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Relatórios &gt; Extravios > Produtos </h4> 
                ...
                <div class="container-fluid">
                 <form action="lista_relatorio_extravio" method="post">
											   <input type="hidden" value="sim" name="exportarextravioproduto">
					 <input type="hidden" value="<?php echo $_POST['produto'] ?>" name="produto"> 
											   <div class="row"> 
			  ...
			  echo "<SELECT NAME='produto' SIZE='1' class='form-control' >

<OPTION VALUE='' SELECTED> Geral ";
// Selecionando os dados da tabela em ordem decrescente
$sql = "SELECT * FROM produtos   ORDER BY produto_nome , produto_departamento";
...
?>
                ...
                <div class="card">
                  <div class="card-body">
                     <h4 class="card-title">Extravio periodo de <?php echo date('d/m/Y', strtotime($_POST['inicio'])); ?> à <?php echo date('d/m/Y', strtotime($_POST['fim'])); ?> <?php if ($_POST['unidade'] =='') { ?> Geral <?php } else { ?> - Unidade: <?php echo $linhauu['unidade_nome'] ?> <?php } ?>  </h4><br>
