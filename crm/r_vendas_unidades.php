                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Relatórios &gt; Total Receitas por unidade</h4> 
...
<select name="ano" class="form-control" id="select" required>
  ...
  <option value="2024">2024</option>
                ...
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Total de receitas: <span style="color:brown"> <?php echo $mes[$numero_mes] ?> / <?php echo $anoatual ?> </span><br><br><br>
