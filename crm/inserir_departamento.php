...
/// INSERINDO DADOS NO BANCO DE DADOS
	 ...
	 @$conn->query($insert = "INSERT INTO produtos_departamentos (departamentos_nome) VALUES ('$_POST[nome]')");
...
<button type="button" class="button"  id="sa-departamento"></button>
