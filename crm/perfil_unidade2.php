                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted mb-0">Total Clientes 2</p>
                                        </div>
                                        <p class="text-muted mt-3 mb-0"><span class="text-success me-1"><i class="mdi mdi-arrow-up-bold me-1"></i>2.65%</span> since last weeka
                                        </p>
                                    </div>
                                </div>
                            </div> <!-- end col-->
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted mb-0">Total vendas</p>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <div>
                                            ...
                                            <p class="text-muted mb-0">Valor total vendas</p>
                                        </div>
