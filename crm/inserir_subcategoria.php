...
/// INSERINDO DADOS NO BANCO DE DADOS
	 ...
	 @$conn->query($insert = "INSERT INTO produtos_subcategorias (subcategoria_departamento, subcategoria_categoria, subcategoria_nome) VALUES ('$_POST[departamento]','$_POST[categoria]','$_POST[subcategoria]')");
...
<button type="button" class="button"  id="sa-subcategoria"></button>
