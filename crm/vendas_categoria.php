...
<!-- Bootstrap Css -->
   <link href="assets/css/bootstrap.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
        ...
        <link href="assets/css/app.min.css" id="app-style" rel="stylesheet" type="text/css" />
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Relatórios &gt; Vendas por categorias</h4> 
				...
				<div class="card">
				<div class="card-body">
                 <form action="vendas_periodo_categoria" method="post">
...
<select class="select2 form-control" id="idSelect2" required multiple="" tabindex="-1" name="local[]" style="display: none;">
      ...
      while ($linha=mysqli_fetch_array($resultado)) {
        ?>
<option value="<?php echo $linha['id_departamentos'] ?>"><?php echo $linha['departamentos_nome'] ?></option>
	<?php } ?>  
