                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Produtos  &gt; Saidas > <a href="perfil_unidade/<?php echo $id ?>"> <?php echo $linhau['unidade_nome'] ?></a> | <span class="card-title">periodo de <?php echo date('d/m/Y H:i:s', strtotime($_POST['inicio'])); ?>  à <?php echo date('d/m/Y H:i:s', strtotime($_POST['fim'])); ?>
