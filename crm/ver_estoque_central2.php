...
?>
                          ...
                          <td ><span style="width: 15px;"> <a href="#" data-bs-toggle="modal" data-bs-target=".modaleditar<?php echo $linhapu['id_produto_central'] ?>"> <?php echo $linhapu['central_produto_estoque'] ?> </a> </span></td>
                          ...
                          <td><span style="width: 15px;"> <a href="#" data-bs-toggle="modal" data-bs-target=".modaleditar<?php echo $linhapu['id_produto_central'] ?>"><?php echo $linhapu['central_produto_qtd_minima'] ?></a></span></td>
                          <td> <a href="#" data-bs-toggle="modal" data-bs-target=".modaleditar<?php echo $linhapu['id_produto_central'] ?>"><?php echo $linhapu['central_produto_qtd_maxima'] ?></a></td>
