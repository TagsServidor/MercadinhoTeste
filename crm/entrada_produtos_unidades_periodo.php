...
$sql = "SELECT SUM(os_produtos_qtd) AS os_produtos_qtd, os_produtos_status, os_produtos_produto, os_produtos_id, os_produtos_cadatro  FROM os_produtos WHERE os_produtos_status ='2' and os_produtos_unidade = $id and os_produtos_cadatro BETWEEN '$_POST[inicio]' AND ' $_POST[fim]'  group by os_produtos_produto    ";
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Produtos &gt; Entradas > <a href="perfil_unidade/<?php echo $id ?>"> <?php echo $linhau['unidade_nome'] ?></a> | <span class="card-title">periodo de <?php echo date('d/m/Y', strtotime($_POST['inicio'])); ?> à <?php echo date('d/m/Y', strtotime($_POST['fim'])); ?>
...
$sqle = "SELECT *  FROM os_produtos WHERE os_produtos_produto ='$linha[os_produtos_produto]' and os_produtos_unidade = $id and os_produtos_status ='2' and os_produtos_cadatro BETWEEN '$_POST[inicio]' AND ' $_POST[fim]' order by os_produtos_id desc   ";
