                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box d-flex align-items-center justify-content-between">
                            <h4 class="mb-0">OS &gt; Concluídas</h4>
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Controle de OS Concluídas</h4>
                                                ...
                                                <tr>
                                                    ...
                                                    ?>
                                                        ...
                                                        <td>
                                                              ...
                                                              <a href="ver_os_reposicao_c/<?php echo $linhaos['id_os_reposicao'] ?>">  <button class="btn btn-outline-secondary btn-sm edit">
