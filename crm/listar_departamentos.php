...
$sql = "SELECT * FROM produtos_departamentos order by departamentos_nome asc ";
                                                    ...
                                                    <div class="modal-dialog modal-dialog-centered">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
																...
																<form id="caddepartamento" method="post" action="inserir_departamento">
																<input class="form-control" name="nome" required placeholder="Informe o nome do departamento"><br>
...
while($linha = mysqli_fetch_array($resultado)){
	...
	?>
                          ...
                          <td><?php if ($linha['departamentos_status'] =='1' ) { ?><span class="btn btn-success btn-sm">Ativo </span><?php } ?> <?php if ($linha['departamentos_status'] =='2' ) { ?><span class="btn btn-danger btn-sm">Inativo </span><?php } ?></td>
                          
                          <td> 
															<input name="id" type="hidden" id="id" value="<?php echo $linha['id_departamentos'] ?>">	
							  
							  <a href="deletar_categoria/<?php echo $linha['id_departamentos'] ?>" onclick="return confirm('Deseja mesmo deletar essa Categoria?');">
