...
<!-- Bootstrap Css -->
   <link href="assets/css/bootstrap.min.css" id="bootstrap-style" rel="stylesheet" type="text/css" />
        ...
        <link href="assets/css/app.min.css" id="app-style" rel="stylesheet" type="text/css" />
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Relatórios &gt; Ajustes em Estoque</h4> 
				...
				<div class="card">
				<div class="card-body">
                 <form action="relatorio_ajustes2" method="post">
...
<select class="select2 form-control" id="idSelect2" required multiple="" tabindex="-1" name="local[]" style="display: none;">
      <option value="8">Encontrados a Mais</option>
	  <option value="3">Vencido</option>
	  <option value="1">Extravio</option>
      <option value="2">Perda</option>
	  <option value="6">Não veio</option>
	  <option value="4">Enviados para mais</option>
	  <option value="10">Perda no caminho</option>
