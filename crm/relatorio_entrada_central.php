                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box d-flex align-items-center justify-content-between">
                                    <h4 class="mb-0">Relatórios &gt; Entradas Central</h4> 
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-body">
                                    <form action="relatorio_entrada_central2" method="post">
                                    <div class="row"> 
...
echo "<SELECT NAME='central' SIZE='1' required class='form-control' >

<OPTION VALUE='' SELECTED> Escolha ";
// Selecionando os dados da tabela em ordem decrescente
$sql = "SELECT * FROM centrais   ORDER BY central_nome";
