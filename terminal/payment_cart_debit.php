...
$conn->query($insert = "INSERT INTO p_apagar (registro_apagar, cliente_apagar, data_apagar, id_terminal, valor, metodo_pagamento, hora_apagar ) VALUES ('$registro_apagar','$id_cliente','$data1','$_POST[terminal]','$_POST[valor]','2','$hora2')");
...
<script type="text/javascript">   
  ...
  function Redirect() 
    {  
        window.location="index.php?unidade=<?php echo $unidade ?>&remover='sim'"; 
    } 
</script>
...
<form id="formcentral" name="a" action="#" method="post">
    ...
    <input type="submit" class="btn" name="tetete" id="clickButton" name="send" style="display:none" >
            ...
            <div class="alert alert-danger text-center" id="myAlert" role="alert">
                ...
                <div class="row justify-content-md-center">
                        <div class="col-md-4 mb-5">
                            <h4 class="text-white ">Pagamento Cartão de Débito </h4>
                        </div>
                    </div>
                ...
                <div class="text-center mt-5 mb-5">  <h2 class="text-white">
                    <?php if ($_GET['retentar'] =='1') { ?>
...
<script>
  $(document).ready(function() {
    ...
    setInterval(function(){
        button.click();
    },2000);  // this will make it click again every 1000 miliseconds
};
	

  jQuery(window).load(function() {
    $(".loader").delay(00).fadeOut("slow"); //retire o delay quando for copiar!
