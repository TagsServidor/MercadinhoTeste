            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-2 float-md-right">
                        <a href="inicio.php" class="btn btn-warning btn-lg btn-theme p-0 mb-3">
        ...
        <div class="col-xl-12 col-lg-12 col-md-12 ">
          <div class="form-section">
            ...
            <div class="text-center mb-5">
              <h4 class="text-white">Complete seu cadastro </h4>
            </div>
            ...
            <?php if ($cliente_nome == '') { ?>
              ...
              <div class="whatsapp-fixo">
                ...
                <div class="wrap">
                  <a href="completar_dados.php" ?>
                    <button class="button2a button2"> <i class="fa fa-user-plus" aria-hidden="true"></i>
                    </button></a>
                </div>
              ...
              <div class="d-flex justify-content-center">
                <div class="col-md-4">
                  <form action="salvar_dados.php" method="post">
                    ...
                    <input class="form-control keyboard-text mb-3" name="nomec" required placeholder="Informe seu nome">
                    <label class="text-white">Data de nascimento:</label>
                    <input class="form-control mb-4" type="date" name="nascimento" required placeholder="Data de Nascimento">
                    <button type="submit" class="btn btn-success btn-lg btn-theme p-0">
            ...
            <div class="row">
              <div class="col-md-12">
                <a href="localizar_produto.php"> </a>
              </div>
